...
// Import images
import profilePic from '../../assets/profile-pic-blue.png'
import linkedinIcon from '../../assets/linkedin.png'
import githubIcon from '../../assets/github.png'
import arrowIcon from '../../assets/arrow.png'
import cvFile from '../../assets/Jeffrey-CV.pdf'

const Hero = () => {
  const handleDownloadCV = () => {
    const link = document.createElement('a');
    link.href = cvFile;
    link.download = 'Jeffrey-David-CV.pdf';
      ...
      <div className="text-center space-y-4 sm:space-y-5 max-w-2xl px-4 relative z-10">
        <div className="space-y-3">
          ...
          <p className="text-md sm:text-lg text-gray-600 dark:text-gray-400 max-w-lg mx-auto mt-4">
            Crafting intelligent solutions through innovative full-stack development and AI integration
          </p>
        </div>
        ...
        <div className="flex gap-6 justify-center mt-8 relative z-10">
          <a 
            href="https://www.linkedin.com/in/jeffrey-david-25a54a204/"
            target="_blank"
          ...
          <a 
            href="https://github.com/Jeffrey-David"
            target="_blank"
            rel="noopener noreferrer"
            className="group relative p-3 bg-white dark:bg-gray-800 rounded-full shadow-md hover:shadow-xl transition-all duration-300"
          >
            <div className="absolute -inset-2 bg-gray-400 rounded-full blur opacity-0 group-hover:opacity-20 transition duration-300"></div>
            <img 
              src={githubIcon}
